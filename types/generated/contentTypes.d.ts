...
export interface ApiSaveStorySaveStory extends Struct.CollectionTypeSchema {
  collectionName: 'save_stories';
  info: {
    singularName: 'save-story';
    pluralName: 'save-stories';
    displayName: 'SaveStory';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    user_list: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiStoryStory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    story_type: Schema.Attribute.String;
    story_subjet: Schema.Attribute.String;
    age_group: Schema.Attribute.String;
    language: Schema.Attribute.String;
    story_title: Schema.Attribute.String;
    save_stories: Schema.Attribute.Relation<
      'oneToMany',
      'api::save-story.save-story'
    >;
    createdAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::save-story.save-story': ApiSaveStorySaveStory;
